...
import re
#import filetutil
REGX_ARRY= [('URL' , ur"((https?|ftp|news):\/\/)?([a-z]([a-z0-9\-]*[\.。])+([a-z]*)|(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5]))(\/[a-z0-9_\-\.~]+)*(\/([a-z0-9_\-\.]*)(\?[a-z0-9+_\-\.%=&]*)?)?(#[a-z][a-z0-9_]*)?"),
            ('SIGN',r"[\.\=、，!！_?？\[\]【】：:。“”…\"〜]+"),
            ('AT',ur"(//)?@[\u4e00-\u9fa5a-z0-9]+"),
            ('FLOAT',ur"\d+\.\d+"),
            ('INTEGER',ur"[0-9]+"),
